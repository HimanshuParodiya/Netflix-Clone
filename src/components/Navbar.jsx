    ...
    <div className={`nav ${show && "nav_black"}`}>
      <div className="nav_contents">
        <img
          ...
          className="nav_logo"
          src={logo}
          alt="Red Color Netflix Logo with  transparent background"
        />
        ...
        <img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHKQHtDytGK38T4XbuIBdgwFFrzP051r1rzA&usqp=CAU"
